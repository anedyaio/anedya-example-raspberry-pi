...
2. Fill credentails.
3. Install neccessary dependency & ready to go.
...
This project is licensed under the [MIT License](https://github.com/anedyaio/anedya-example-pi/blob/development/LICENSE).
